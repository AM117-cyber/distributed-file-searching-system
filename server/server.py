...
def get_preview(file_content, file_name_plus_type):
    ...
    try:
        if mime_type and mime_type.startswith('text'):
            ...
            preview = generate_docx_preview(file_content)
        elif mime_type == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet':
            preview = generate_xlsx_preview(file_content)
        elif mime_type and mime_type.startswith('image'):
            preview = generate_image_preview(file_content)
        elif mime_type and mime_type.startswith('audio'):
            preview = generate_audio_preview(file_content)
